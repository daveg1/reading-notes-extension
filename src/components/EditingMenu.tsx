...
export function EditingMenu() {
  ...
  return (
    <div className="flex h-7 w-full select-none items-center gap-2">
      ...
      <button
        className="h-7 rounded border border-red-300 bg-red-50 px-2 transition-opacity hover:opacity-75 disabled:pointer-events-none disabled:opacity-50"
      ...
      <button
        className="h-7 rounded border border-gray-300 bg-white px-2 transition-opacity hover:opacity-75"
