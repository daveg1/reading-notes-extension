/**
 * Text fragment generation script borrowed from:
...
const e = [
  ...
  u = (e) => {
    ...
    for (; !e.collapsed && null != s; ) {
      ...
      try {
        ...
        ;(s = t.nextNode()), null == s ? e.collapse() : e.setStart(s, 0)
      }
    }
  },
  a = (e) =>
  ...
  i = (e) => {
    let t = e
    for (; null != t && !(t instanceof HTMLElement); ) t = t.parentNode
    if (null != t) {
    ...
    for (let u = 0; u < t.length; u++) {
      ...
      if ((s && (i += 1), i > e)) {
        ...
        for (; u >= 0 && u <= a.data.length; ) {
          ...
          ;(u += o), (f = S(s ? a.data.substring(0, u) : a.data.substring(u)))
        }
      }
      if (((r += n.length), u + 1 < t.length)) {
        const e = S(t[u + 1].data)
        ' ' === n.slice(-1) && ' ' === e.slice(0, 1) && (r -= 1), (n = e)
      }
    }
  },
  D = (e, s, n, r) => {
    if (s < 0 || s >= e.length || n <= 0 || s + n > e.length) return !1
    if (r) {
      const t = r.segment(e),
        u = t.containing(s)
      if (!u) return !1
...
const O = (e) => {
  ...
  p = (e) => {
    if (!e.toString().substring(0, 1e4).match(g.NON_BOUNDARY_CHARS)) return !1
    try {
      if (e.startContainer.ownerDocument.defaultView !== window.top) return !1
    } catch {
      return !1
    }
  ...
  B = (e, t) => {
    ...
    if (P(e)) {
      const t = g.normalizeString(e.toString()),
        s = { textStart: t }
      if (t.length >= 20 && L(s)) return { status: N.SUCCESS, fragment: s }
  ...
  b = class {
    constructor() {
      ;(this.Mode = { ALL_PARTS: 1, SHARED_START_AND_END: 2, CONTEXT_ONLY: 3 }),
      ...
      if (
        ...
        if (this.startOffset < this.getStartSearchSpace().length) {
          ...
          if (null != this.getStartSegments())
            for (
              ;
              t < e && this.startOffset < this.getStartSearchSpace().length;
      ...
      if (
        ...
        if (this.suffixOffset < this.getSuffixSearchSpace().length) {
          ...
          if (null != this.getSuffixSegments())
            for (
              ;
              t < e && this.suffixOffset < this.getSuffixSearchSpace().length;
    ...
    setExactTextMatch(e) {
      return (
        (this.exactTextMatch = e), (this.mode = this.Mode.CONTEXT_ONLY), this
      )
    }
    ...
    getNumberOfContextWordsToAdd() {
      return 0 === this.backwardsPrefixOffset() && 0 === this.suffixOffset
        ? 3
        : 1
    }
    ...
    getNextOffsetBackwards(e, t) {
      ...
      for ((s && t != s.index) || (s = e.containing(t - 1)); null != s; ) {
  ...
  L = (e) =>
    ...
    ((e, t = document) => {
      const a = [],
        i = t.createRange()
      for (i.selectNodeContents(t.body); !i.collapsed && a.length < 2; ) {
        let f
        if (e.prefix) {
          ...
          if (0 !== f.compareBoundaryPoints(Range.START_TO_START, n)) continue
        } else {
        ...
        if (e.textEnd) {
          ...
          if (u === s.SUFFIX_MATCH) {
            a.push(f.cloneRange()), r(i, i.startContainer, i.startOffset)
            continue
          }
  ...
  X = (e) => {
    ...
    for (; !t.collapsed && null != s; ) {
      if (J(s)) return !0
      null != s && t.setStartAfter(s), (s = g.forwardTraverse(n, r)), _()
    }
    return !1
  },
  W = (e, t) => {
    ...
    if (s < e.data.length && g.BOUNDARY_CHARS.test(e.data[s])) return s
  ...
  Y = (e, t) => {
    if (e.nodeType !== Node.TEXT_NODE) return -1
    const s = null != t ? t : 0
    if (s < e.data.length && s > 0 && g.BOUNDARY_CHARS.test(e.data[s - 1]))
      return s
  ...
  V = (e, t) => {
    ...
    let s = e
    const n = null != t ? t : e
    for (; !s.contains(n) || !J(s); ) s.parentNode && (s = s.parentNode)
  ...
  z = (e, t, s) => {
    ...
    let i = u.length
    n.node.nodeType === Node.TEXT_NODE ? (i += n.offset) : t && (i += a.length)
    const f = r.postNodes.reduce((e, t) => e.concat(t.textContent), ''),
      o = [...r.preNodes, ...r.innerNodes, ...r.postNodes]
    if (0 == o.length) return
    const c = u.concat(a, f),
      d = e.segment(c).containing(i)
    if (!d)
      return void (t ? s.setEndAfter(o[o.length - 1]) : s.setEndBefore(o[0]))
  ...
  j = (e) => {
    ...
    if (e.nodeType === Node.TEXT_NODE) u.push(e)
      ...
      let s = t.nextNode()
      for (; null != s; )
        _(), s.nodeType === Node.TEXT_NODE && u.push(s), (s = t.nextNode())
    }
    const a = [],
      i = V(e)
    if (!i) return
...
var GenerateFragmentStatus = N,
  forTesting = $,
  generateFragment = x,
  generateFragmentFromRange = T,
  isValidRangeForFragmentGeneration = p,
  setTimeout = O
// export{N as GenerateFragmentStatus,$ as forTesting,x as generateFragment,T as generateFragmentFromRange,p as isValidRangeForFragmentGeneration,O as setTimeout};
...
chrome.runtime.onMessage.addListener((message, _sender, sendResponse) => {
  if (message) {
    sendResponse({ reply: getFragment() })
  }
})

console.log('[reading notes] loaded text fragment')
